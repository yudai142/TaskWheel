      ...
      {showForm && (
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700">当番名</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">複数割り当て数</label>
              <input
                type="number"
                className="input-field"
        ...
        {works.map((work) => (
          <div key={work.id} className="card">
            <div className="flex items-start justify-between">
              ...
              <button onClick={() => handleDelete(work.id)} className="btn-danger">
                削除
              </button>
            </div>
          </div>
